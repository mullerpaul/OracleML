-- Create a table to hold, and then load a well-known dataset.
-- Or at least its well-known to _somebody_.  I'd never heard of it before today!
DROP TABLE iris PURGE;
CREATE TABLE iris
  (observation_id NUMBER GENERATED ALWAYS AS IDENTITY,
   sepal_length   NUMBER NOT NULL,
   sepal_width    NUMBER NOT NULL,
   petal_length   NUMBER NOT NULL,
   petal_width    NUMBER NOT NULL,
   class          VARCHAR2(20)
  );

INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (5.1, 3.5, 1.4, 0.2, 'Iris-setosa');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (4.9, 3, 1.4, 0.2, 'Iris-setosa');
...
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (5, 3.6, 1.4, 0.2, 'Iris-setosa');
...
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (5, 3.4, 1.5, 0.2, 'Iris-setosa');
...
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (4.8, 3, 1.4, 0.1, 'Iris-setosa');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (4.3, 3, 1.1, 0.1, 'Iris-setosa');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (5.8, 4, 1.2, 0.2, 'Iris-setosa');
...
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (4.6, 3.6, 1, 0.2, 'Iris-setosa');
...
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (5, 3, 1.6, 0.2, 'Iris-setosa');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (5, 3.4, 1.6, 0.4, 'Iris-setosa');
...
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (4.9, 3.1, 1.5, 0.1, 'Iris-setosa');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (5, 3.2, 1.2, 0.2, 'Iris-setosa');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (5.5, 3.5, 1.3, 0.2, 'Iris-setosa');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (4.9, 3.1, 1.5, 0.1, 'Iris-setosa');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (4.4, 3, 1.3, 0.2, 'Iris-setosa');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (5.1, 3.4, 1.5, 0.2, 'Iris-setosa');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (5, 3.5, 1.3, 0.3, 'Iris-setosa');
...
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (5, 3.5, 1.6, 0.6, 'Iris-setosa');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (5.1, 3.8, 1.9, 0.4, 'Iris-setosa');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (4.8, 3, 1.4, 0.3, 'Iris-setosa');
...
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (5, 3.3, 1.4, 0.2, 'Iris-setosa');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (7, 3.2, 4.7, 1.4, 'Iris-versicolor');
...
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (5.5, 2.3, 4, 1.3, 'Iris-versicolor');
...
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (4.9, 2.4, 3.3, 1, 'Iris-versicolor');
...
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (5, 2, 3.5, 1, 'Iris-versicolor');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (5.9, 3, 4.2, 1.5, 'Iris-versicolor');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (6, 2.2, 4, 1, 'Iris-versicolor');
...
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (5.6, 3, 4.5, 1.5, 'Iris-versicolor');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (5.8, 2.7, 4.1, 1, 'Iris-versicolor');
...
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (6.1, 2.8, 4, 1.3, 'Iris-versicolor');
...
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (6.6, 3, 4.4, 1.4, 'Iris-versicolor');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (6.8, 2.8, 4.8, 1.4, 'Iris-versicolor');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (6.7, 3, 5, 1.7, 'Iris-versicolor');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (6, 2.9, 4.5, 1.5, 'Iris-versicolor');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (5.7, 2.6, 3.5, 1, 'Iris-versicolor');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (5.5, 2.4, 3.8, 1.1, 'Iris-versicolor');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (5.5, 2.4, 3.7, 1, 'Iris-versicolor');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (5.8, 2.7, 3.9, 1.2, 'Iris-versicolor');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (6, 2.7, 5.1, 1.6, 'Iris-versicolor');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (5.4, 3, 4.5, 1.5, 'Iris-versicolor');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (6, 3.4, 4.5, 1.6, 'Iris-versicolor');
...
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (5.6, 3, 4.1, 1.3, 'Iris-versicolor');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (5.5, 2.5, 4, 1.3, 'Iris-versicolor');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (5.5, 2.6, 4.4, 1.2, 'Iris-versicolor');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (6.1, 3, 4.6, 1.4, 'Iris-versicolor');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (5.8, 2.6, 4, 1.2, 'Iris-versicolor');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (5, 2.3, 3.3, 1, 'Iris-versicolor');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (5.6, 2.7, 4.2, 1.3, 'Iris-versicolor');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (5.7, 3, 4.2, 1.2, 'Iris-versicolor');
...
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (5.1, 2.5, 3, 1.1, 'Iris-versicolor');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (5.7, 2.8, 4.1, 1.3, 'Iris-versicolor');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (6.3, 3.3, 6, 2.5, 'Iris-virginica');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (5.8, 2.7, 5.1, 1.9, 'Iris-virginica');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (7.1, 3, 5.9, 2.1, 'Iris-virginica');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (6.3, 2.9, 5.6, 1.8, 'Iris-virginica');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (6.5, 3, 5.8, 2.2, 'Iris-virginica');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (7.6, 3, 6.6, 2.1, 'Iris-virginica');
...
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (6.5, 3.2, 5.1, 2, 'Iris-virginica');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (6.4, 2.7, 5.3, 1.9, 'Iris-virginica');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (6.8, 3, 5.5, 2.1, 'Iris-virginica');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (5.7, 2.5, 5, 2, 'Iris-virginica');
...
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (6.5, 3, 5.5, 1.8, 'Iris-virginica');
...
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (6, 2.2, 5, 1.5, 'Iris-virginica');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (6.9, 3.2, 5.7, 2.3, 'Iris-virginica');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (5.6, 2.8, 4.9, 2, 'Iris-virginica');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (7.7, 2.8, 6.7, 2, 'Iris-virginica');
...
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (7.2, 3.2, 6, 1.8, 'Iris-virginica');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (6.2, 2.8, 4.8, 1.8, 'Iris-virginica');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (6.1, 3, 4.9, 1.8, 'Iris-virginica');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (6.4, 2.8, 5.6, 2.1, 'Iris-virginica');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (7.2, 3, 5.8, 1.6, 'Iris-virginica');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (7.4, 2.8, 6.1, 1.9, 'Iris-virginica');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (7.9, 3.8, 6.4, 2, 'Iris-virginica');
...
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (7.7, 3, 6.1, 2.3, 'Iris-virginica');
...
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (6, 3, 4.8, 1.8, 'Iris-virginica');
...
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (6.7, 3, 5.2, 2.3, 'Iris-virginica');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (6.3, 2.5, 5, 1.9, 'Iris-virginica');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (6.5, 3, 5.2, 2, 'Iris-virginica');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (6.2, 3.4, 5.4, 2.3, 'Iris-virginica');
INSERT INTO iris (sepal_length, sepal_width, petal_length, petal_width, class) VALUES (5.9, 3, 5.1, 1.8, 'Iris-virginica');
